...
- **`skills/`** — `secondbrain` (setup orchestrator) + `secondbrain-doctor` (integrity
  ...
  ported `yt-fetch` / `voice-fetch` / `code-fetch` / `notebooklm-ingest`.
